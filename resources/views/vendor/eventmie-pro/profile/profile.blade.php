                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                {{-- CUSTOM --}}
                                    ...
                                    {{-- CUSTOM --}}
                                    @include('vendor.eventmie-pro.profile.custom.image_upload')
                                    {{-- CUSTOM --}}
                                    ...
                                    {{-- CUSTOM --}}
                                    <div class="form-group row">
                                        <label class="col-md-3">@lang('eventmie-pro::em.taxpayer_number')</label>
                                        <div class="col-md-9">
                                            <input class="form-control" name="taxpayer_number" type="text"  value="{{$user->taxpayer_number}}" >
                                            @if ($errors->has('taxpayer_number'))
                                                <div class="error">{{ $errors->first('taxpayer_number') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    {{-- CUSTOM --}}
                                    ...
                                    @if(Auth::user()->hasRole('organiser'))
                                        @include('vendor.eventmie-pro.profile.custom.connect-stripe')
                                    @endif
                                    ...
                                    @if(!Auth::user()->hasRole('customer'))
                                        ...
                                        {{-- CUSTOM --}}
                                        @include('vendor.eventmie-pro.profile.custom.organizer_profile')
                                        @include('vendor.eventmie-pro.profile.custom.seller_info')
                                        @include('vendor.eventmie-pro.profile.custom.mailchimp')
                                        {{-- CUSTOM --}}
