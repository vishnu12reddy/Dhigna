...
@section('page_title', 'Bulk Bookings')

@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="voyager-wallet"></i> Bulk Bookings
        </h1>
                                        ...
                                        @if($key == 0)
                                            <th>
                                                @if ($isServerSide)
                                                        ...
                                                        @if ($sortOrder == 'asc')
                                                            <a href="{{ url('admin/bookings/bulk?sort_order=desc&order_by=bulk_code') }}">
                                                            
                                                            {{ __('eventmie-pro::em.bulk_code') }}
                                                            <i class="voyager-angle-up pull-right"></i>
                                                        @else
                                                            <a href="{{ url('admin/bookings/bulk?sort_order=asc&order_by=bulk_code') }}">
                                                                {{ __('eventmie-pro::em.bulk_code') }}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            <a href="{{ route('voyager.bookings.bulk_edit',[$data->id])}}" class="btn btn-sm btn-info edit pull-right">
                                                <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">{{ __('voyager::generic.edit') }}</span>
                                            </a>

                                            <a href="{{ route('voyager.bookings.bulk_show',[$data->id])}}" class="btn btn-sm btn-warning view pull-right">
                                                <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">{{ __('voyager::generic.view') }}</span>
                                            </a>

                                            <a href="{{ route('voyager.bookings.bulk_zip',[$data->ticket_id, $data->bulk_code])}}" class="btn btn-sm btn-success download pull-right">
                                                <i class="voyager-download"></i> <span class="hidden-xs hidden-sm">{{ __('eventmie-pro::em.download_zip') }}</span>
                                            </a>

                                            <a href="{{ route('voyager.bookings.bulk_export',[$data->ticket_id, $data->bulk_code])}}" class="btn btn-sm btn-success download pull-right">
                                                <i class="voyager-download"></i> <span class="hidden-xs hidden-sm">{{ __('eventmie-pro::em.export_attendees') }}</span>
                                            </a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form action="{{ route('voyager.bookings.bulk_delete',[$data->id]) }}" id="delete_form" method="GET">
                                                                {{ csrf_field() }}
