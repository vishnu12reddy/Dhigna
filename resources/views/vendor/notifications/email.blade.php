            ...
            <tr>
                ...
                <![endif]-->
                    <table role="presentation"
                        ...
                        <tr>
                            <td
                                style="padding:5px 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                                <!--[if mso]>
                ...
                <![endif]-->
                                ...
                                <h4
                                    style="margin-top:0;margin-bottom:16px;font-size:16px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;text-align: center;">
                                    {{ $line }}</h4>
                                @endforeach
                                <div
