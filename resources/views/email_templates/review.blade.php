                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <h1
                                    ...
                                    @lang('eventmie-pro::em.thank_you_rating')</h1>
                                <p style="margin:0;">@lang('eventmie-pro::em.appreciate_it')</p>
                            </td>
                        </tr>
                                    ...
                                    <table style="width:100%;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                                        <tr>
                                            <td
                                                ...
                                                @lang('eventmie-pro::em.review_name')</td>
                                            <td
                                        ...
                                        <tr>
                                            <td
                                                style="padding: 10px; border-bottom: 1px solid #ededed; width: 35%; font-weight:500; color:rgba(0,0,0,.64)">
                                                @lang('eventmie-pro::em.review_email')</td>
                                            <td
                                                style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;">
                                                {{ $mail['user']['email'] }}</td>
                                        </tr>
                                        <tr>
                                            <td
                                                style="padding: 10px; border-bottom: 1px solid #ededed; width: 35%; font-weight:500; color:rgba(0,0,0,.64)">
                                                @lang('eventmie-pro::em.review_event')</td>
                                            <td
                                                style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;">
                                                {{ $mail['event']['title'] }}</td>
                                        </tr>
                                        <tr>
                                            <td
                                                style="padding: 10px; border-bottom: 1px solid #ededed; width: 35%; font-weight:500; color:rgba(0,0,0,.64)">
                                                @lang('eventmie-pro::em.review_rating')</td>
                                            <td
                                                style="padding: 10px; border-bottom: 1px solid #ededed; color: #455056;">
                                                {{ $mail['review']['rating'] }} / 5</td>
                                        </tr>
                                        <tr>
                                            <td
                                                style="padding: 10px; width: 35%; font-weight:500; color:rgba(0,0,0,.64)">
                                                @lang('eventmie-pro::em.review_review')</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="padding:10px;background-color:#ffffff;">
                                                <p style="margin:0;color: #455056;">{!! $mail['review']['review'] !!}</p>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
