...
class PosController extends Controller
{
    ...
    public function index()
    {
        ...
        // show organiser_bookings for pos organizer
        return view('pos_bookings.index', compact('path', 'is_success'));

    }
    
    
    // get organizer's booking for pos organizer 
    public function bookings(Request $request)
    {
        ...
        $pos_organizer_id = Auth::id();    

        // get related event's ids for pos organizer 
        $event_ids   = $this->pos->get_pos_event_ids($pos_organizer_id);
        
        $params['event_ids'] = $event_ids;


        $bookings    = $this->pos->get_bookings($params);
    ...
    // booking edit for customer by pos organizer
    public function edit_bookings(Request $request)
    {
        ...
        // check booking id in booking table for pos organiser
        $check_booking     = (array) $this->pos->check_booking($params);
        ...
        // booking edit
        $booking_edit    = $this->pos->edit_booking($data, $params);
        ...
        // edit commision table status when change booking table status change by pos organiser 
    ...
    // view coustomer booking by pos oraganizer
    public function show($id = null, $view = 'pos_bookings.show', $extra = [])
    {
        ...
        $booking = $this->pos->get_booking($params);   
    ...
    /**
     *  get all events for related pos_organizer
     */
    ...
    public function events()
    {
        ...
        // get related event's ids for pos organizer 
        $myevents    = $this->pos->get_events($params);
